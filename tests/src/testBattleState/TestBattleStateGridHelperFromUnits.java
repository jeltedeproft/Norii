...
public class TestBattleStateGridHelperFromUnits {
	...
	public void testLineHorizontalLine() {
		...
		ability.getSpellData().setLineOfSight("LINE");
		final Array<MyPoint> unitPositions = new Array<>();
		unitPositions.addAll(new MyPoint[] { testPoints[7][7], testPoints[6][6], testPoints[4][4], testPoints[3][3], testPoints[3][4], testPoints[4][3], testPoints[7][6], testPoints[6][7], testPoints[6][4], testPoints[7][4], testPoints[6][3], testPoints[7][3], testPoints[4][6],
				testPoints[4][7], testPoints[3][6], testPoints[3][7] });
		final Array<MyPoint> results = gridHelper.getTargetPositionsInRangeAbility(center, ability, allPoints);
		unitPositions.sort();
		results.sort();
		assertEquals(unitPositions, results);
	...
	public void testLineVerticalLine() {
		...
		ability.getSpellData().setLineOfSight("LINE");
		final Array<MyPoint> unitPositions = new Array<>();
		unitPositions.addAll(new MyPoint[] { testPoints[5][6], testPoints[5][7], testPoints[5][4], testPoints[5][3], testPoints[4][5], testPoints[3][5], testPoints[6][5], testPoints[7][5], testPoints[5][5], testPoints[8][5], testPoints[9][5], testPoints[2][5], testPoints[1][5],
				testPoints[5][8], testPoints[5][9], testPoints[5][2], testPoints[5][1] });
		final Array<MyPoint> results = gridHelper.getTargetPositionsInRangeAbility(center, ability, allPoints);
		unitPositions.sort();
		results.sort();
		assertEquals(unitPositions, results);
	...
	public void testLineCircle() {
		...
		ability.getSpellData().setLineOfSight("LINE");
		final Array<MyPoint> unitPositions = new Array<>();
		unitPositions.addAll(new MyPoint[] { testPoints[5][5], testPoints[5][6], testPoints[5][7], testPoints[5][8], testPoints[5][9], testPoints[5][4], testPoints[5][3], testPoints[5][2], testPoints[5][1], testPoints[6][5], testPoints[6][6], testPoints[6][7], testPoints[6][8],
				testPoints[6][4], testPoints[6][3], testPoints[6][2], testPoints[7][5], testPoints[7][6], testPoints[7][7], testPoints[7][4], testPoints[7][3], testPoints[8][5], testPoints[8][6], testPoints[8][4], testPoints[9][5], testPoints[4][5], testPoints[4][6],
				testPoints[4][7], testPoints[4][8], testPoints[4][4], testPoints[4][3], testPoints[4][2], testPoints[3][5], testPoints[3][6], testPoints[3][7], testPoints[3][4], testPoints[3][3], testPoints[2][5], testPoints[2][6], testPoints[2][4], testPoints[1][5] });
		final Array<MyPoint> results = gridHelper.getTargetPositionsInRangeAbility(center, ability, allPoints);
		unitPositions.sort();
		results.sort();
		assertEquals(unitPositions, results);
