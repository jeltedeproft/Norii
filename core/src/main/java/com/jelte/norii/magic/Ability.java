...
public class Ability {
	...
	public enum AreaOfEffect {
		CELL, HORIZONTAL_LINE_RIGHT, VERTICAL_LINE_UP, VERTICAL_LINE_DOWN, CIRCLE, CROSS, SQUARE, HORIZONTAL_LINE_LEFT, DIAGONAL_RIGHT, DIAGONAL_LEFT, SQUARE_BORDER, CIRCLE_BORDER
	}
