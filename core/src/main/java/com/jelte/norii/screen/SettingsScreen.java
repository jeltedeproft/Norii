...
public class SettingsScreen implements Screen {
	private static final String SETTINGS_BACKGROUND = "forestbg";
	...
	private void initializeBgAnimation() {
		bg = AssetManagerUtility.getTextureAsset(SETTINGS_BACKGROUND);
	}
	...
	public void updatebg(final float delta) {
		...
		backgroundbatch.draw(bg, 0, 0, stage.getViewport().getWorldWidth(), stage.getViewport().getWorldHeight());
		backgroundbatch.end();
	}
